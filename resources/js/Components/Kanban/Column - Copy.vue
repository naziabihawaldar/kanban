...
const boardID = computed(() => props?.column?.board);
const cardsRef = ref();
const group_user = ref();
const filter_cards = computed(() => props?.filterCards);

if(typeof filter_cards.value != 'undefined' && filter_cards.value != '')
{
  var datas = filter_cards.value;
  cards.value = null;
