...
class ReportController extends Controller
{
    ...
    {
        return inertia("ReportList");
    }
    public function consolidatedReport(Request $request)
    {
        return inertia("Consolidated");
    }
    public function getconsolidatedReportData(Request $request)
    {
        try 
        {
    ...
    {
        return (new ConsolidatedReportExport($request))->download('reports.csv');
    }
